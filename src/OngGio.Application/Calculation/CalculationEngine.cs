...
/// Engine trung tâm: đánh giá công thức từ DB hoặc fallback class C#, rồi tính giá trị báo giá.
...

{
...

    {
...

        {
            ...
            ssx1Cai = _dbFormulaEvaluator.Evaluate(nhomSanPham.CongThucDienTich, thamSo);
...

        {
            ...
            ssx1Cai = areaResult.SSx1Cai;

            trangThaiCongThuc = areaResult.TrangThaiCongThuc;
